...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Organization Owner'];
  const customerRoles: string[] = ['Guest User'];
  const tenantRoles: string[] = ['Organization Owner'];
  const addOns: string[] = ['notifications'];
  const applicationName = `Poocho`;
